...
contract TwitterUtilsTest is Test {
    ...
    function testVerifyTestEmail() public {
        ...
        uint256[2] memory proof_a = [
            6404912091111111111111111111111692679163975170331123763947869280533330020948,
            16431746252111111111111111144362323467317260581534469863954001717354720033449
        ];
        // Note: you need to swap the order of the two elements in each subarray
        uint256[2][2] memory proof_b = [
            [
                8795231851098125111111111111111111111473503351895932688930282151189868525269,
                8400965518420081511111111111111111115192033588615011110881123763850464376004
            ],
            [
                1261603040832110111111111111111111111168501842246415202852613834792443845304,
                13121771595022701111111111111111111165032821396670202768909783661374406380222
            ]
        ];
        uint256[2] memory proof_c = [
            16050409289279435711111111111111111116910719341869168962865371387104118882619,
            18176072645632006411111111111111111111818956668410385812518837732883642216531
        ];
    ...
    function testVerifyYushEmail() public {
        ...
        // TODO switch order
        uint256[2] memory proof_a = [
            16235597139600534219471111111111111111111111111822970670513181240240086214174,
            6621518204030293388915311111111111111111111111041615077394701602185030032541
        ];
        // Note: you need to swap the order of the two elements in each subarray
        uint256[2][2] memory proof_b = [
            [
                6161412334642964861111111111111111111111115036507487954316771559158415662599,
                6394243861551970426111111111111111111111111351061112276435055148070946593649
            ],
            [
                10941698291835179415420256111111111111111111111111139219040895798597821967702,
                7728456040917771404709714591111111111111111111111111164164791489962500861862
            ]
        ];
        uint256[2] memory proof_c = [
            14259974788240734152903966067511111111111111111111111111164767170021226788296,
            21676216180115608963745703352111111111111111111111111035841665454472016757320
        ];
